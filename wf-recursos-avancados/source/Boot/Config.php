...
define("CONF_URL_TEST", "http://www.localhost/wf-recursos-avancados");
...
define("CONF_MAIL_SENDER", ["name" => "Robson V. Leite", "address" => "email@provider.com"]);
define("CONF_MAIL_SUPPORT", "email@provider.com");
